...
Eqn from ASCII files (CSR)
Construct RHS for given solution.
...
Step  0:    100 of the    100 unknowns eliminated exactly.
Total time Preconditioner:    0.00


Number of non-zeros in the LDU-decomposition:         0
Number of non-zeros in last block:                    0
Average number of non-zeros per row in L+D+U:     NaN     
Time Solution:    0.00
