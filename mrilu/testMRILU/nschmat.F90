...
PROGRAM nschmat
!      this program tests the facility of altering the matrix and 
!      keeping the preconditioning the same.
...
!       with   b := A xRef:
      ...
      CALL cmpsolprc2 (BlkSiz, A, b, x, nrsteps, testx, xRef)
