...
% Usage: view_mask(<mask_name>) 
%        where <mask_name> is the name of a .mat mask file\n',...
%        without the .mat\n'
    if nargin < 1
        fprintf(['Usage: view_mask(<mask_name>) \n',...
                 '       where <mask_name> is the name of a .mat mask file\n',...
                 '       without the .mat\n']);
        return;
    end
    special_colormap = false;
    ...
    %------------------------------------------------------------------
    % Display any transects supplied in the mat file
    %------------------------------------------------------------------
